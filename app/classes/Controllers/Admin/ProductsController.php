...
class ProductsController extends BaseController{
    ...
    function index(): ?string
    {
        ...
        $this->page->setContent($content->render('content/admin/products/view.tpl.php'));
    ...
    /**
     * rodo/procesina produkto sukūrimo formą.
     */
   function create(): ?string
   {
       ...
       $this->page->setContent($content->render('content/admin/products/add-edit.tpl.php'));

       return $this->page->render();
   }

    /**
     * rodo/procesina produkto redagavimo formą.
     */
